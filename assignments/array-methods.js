...
runners.forEach(function (runners) {
    let full_name = runners.first_name + " " + runners.last_name;
...
// Problem 1
// Create the "thankyou" message for taking part in this run
let ThankYouMessage = [];
runners.forEach ((runners) =>{
    ThankYouMessage.push(runners.company_name +", thank you for your participation!");
})
console.log(ThankYouMessage);

// Problem 2
// The participant #24 decided to pay extra 50% of previously paid ammount and the participant #33 extra 10%. Count new ticket Price total
let newTicketPriceTotal = [];
runners[23].donation = 1.5*runners[23].donation;
runners[32].donation = 1.1*runners[32].donation;
newTicketPriceTotal = runners.reduce ((total, runners) => {
    return total += runners.donation;
}, 0);
console.log(newTicketPriceTotal);


// Problem 3
// Count how many companies donated less more than $200. Count the total ammount
let morethan200 = [];
morethan200 = runners.filter ((runners) => {
    return runners.donation > 200;
})
console.log(morethan200.length);

let totalMorethan200 =[];
totalMorethan200 = morethan200.reduce((total, morethan200) => {
    return total += morethan200.donation;
}, 0);
console.log(totalMorethan200);
